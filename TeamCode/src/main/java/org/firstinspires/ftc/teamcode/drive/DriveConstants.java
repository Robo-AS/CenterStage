...
public class DriveConstants {
     ...
     */
    public static double WHEEL_RADIUS = 1.8898; // in //TREBUIE SCHIMBAT AICI DACA SCHIMBAM ROTILE//ROTI DE 96MM aici
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 13.97638; // in //DISTANTA DINTRE CENTRELE ROTILOR DIN SPATELE ROBOTULUI
    ...
    public static double encoderTicksToMM(double ticks) {
        return (WHEEL_RADIUS * 2 * Math.PI * GEAR_RATIO * ticks / TICKS_PER_REV) * 25.4;
    }
