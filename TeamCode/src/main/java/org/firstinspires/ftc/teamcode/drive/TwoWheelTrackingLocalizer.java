...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = 78; // X is the up and down direction
    public static double PARALLEL_Y = 305; // Y is the strafe direction

    public static double PERPENDICULAR_X = 245;
    public static double PERPENDICULAR_Y = 142;
